...
void menu(Node*& head)
{
	...
	cout << "7) Найти сумму положительных чисел, оканчивающихся на 7:" << endl;
	cout << "8) Выход..." << endl;
	cin >> choice;
...
void calculations(Node* head)
{
	...
	if (found) 
	{
		cout << "Сумма положительных чисел, оканчивающихся на 7: " << sum << endl;
	}
	else 
	{
